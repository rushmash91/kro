...
func eksCluster(
	...
	*krov1alpha1.ResourceGraphDefinition,
	...
	resourcegraphdefinition := generator.NewResourceGraphDefinition(name,
		...
		generator.WithResource("clusterRole", clusterRoleDef(namespace), nil, nil, nil),
		generator.WithResource("clusterVPC", vpcDef(namespace), nil, nil, nil),
		generator.WithResource("clusterInternetGateway", igwDef(namespace), nil, nil, nil),
		generator.WithResource("clusterRouteTable", routeTableDef(namespace), nil, nil, nil),
		generator.WithResource(
			"clusterSubnetA",
			subnetDef(namespace, "kro-cluster-public-subnet1", "us-west-2a", "192.168.0.0/18"),
			nil,
			nil,
			nil,
		),
		generator.WithResource(
			"clusterSubnetB",
			subnetDef(namespace, "kro-cluster-public-subnet2", "us-west-2b", "192.168.64.0/18"),
			nil,
			nil,
			nil,
		),
		generator.WithResource("cluster", clusterDef(namespace), nil, nil, nil),
		generator.WithResource("clusterAdminRole", adminRoleDef(namespace), nil, nil, nil),
		generator.WithResource("clusterElasticIPAddress", eipDef(namespace), nil, nil, nil),
		generator.WithResource("clusterNATGateway", natGatewayDef(namespace), nil, nil, nil),
		generator.WithResource("clusterNodeRole", nodeRoleDef(namespace), nil, nil, nil),
		generator.WithResource("clusterNodeGroup", nodeGroupDef(namespace), nil, nil, nil),
	)
